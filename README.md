...
Backend
Python
Flask / FastAPI (update based on what you used)
Machine Learning
...
How It Works - 
User interacts with the chatbot via UI
Input is sent to backend API
Emotion detection model analyzes user input
Chatbot generates response based on emotion + query
